...
partial class Program
{
    ...
    private static void OutputEnumNames()
    {
        ...
        WriteLine("Truncated to 8 characters: {0}", favoriteAncientWonder.ToString().Truncate(8));
    ...
    private static void NumberFormatting()
    {
        ...
        string[] things = ["fox", "person", "sheep", "apple", "goose", "oasis", 
            "potato", "die", "dwarf", "attorney general", "biceps"];
        ...
        WriteLine("Original: {0}, Metric: {1}", 
            thousands, thousands.ToMetric(MetricNumeralFormats.WithSpace | MetricNumeralFormats.UseShortScaleWord, decimals: 0));
