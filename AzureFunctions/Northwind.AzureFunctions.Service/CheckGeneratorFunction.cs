...
using SixLabors.ImageSharp.Processing; // To use Brush, Pen.
...
public class CheckGeneratorFunction
{
    ...
    {
        _logger = loggerFactory.CreateLogger<CheckGeneratorFunction>();
    }
    ...
    public byte[] Run([QueueTrigger("checksQueue")] string message)
    {
        ...
        using (Image<Rgba32> image = 
            new(width: 1200, height: 600, backgroundColor: new Rgba32(r: 255, g: 255, b: 255, a: 100)))
        {
