...
var host = new HostBuilder()
    ...
    {
        services.AddHttpClient(name: "Amazon", configureClient: options =>
        {
            ...
            options.DefaultRequestHeaders.UserAgent.Add(new ProductInfoHeaderValue(productName: "Chrome", productVersion: "114.0.5735.91"));
        });
    })
    .Build();
