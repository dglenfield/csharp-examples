...
using Microsoft.EntityFrameworkCore; // To use ToQueryString, GetConnectionString.
...
{
    builder.DataSource = "tcp:apps-services-book-dg.database.windows.net,1433"; // Azure SQL Database
}
