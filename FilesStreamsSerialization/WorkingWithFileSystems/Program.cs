...
WriteLine($"Random File Name: {GetRandomFileName()}"); // Returns a filename, doesn't create the file.
WriteLine($"Temporary File Name: {GetTempFileName()}"); // Creates a zero-byte file and returns its name.
