...
partial class Program
{
    ...
    /* Recursion is clever but can lead to problems, such as a stack overflow due to too many function calls because memory is used to
     * store data on every function call, an it eventually uses too much. 
     * 
     * Iteration is a more practical, if less succinct, solution. */
    ...
    static void RunFibFunctional()
    {
        for (uint i = 1; i <=30; i++)
        {
            WriteLine("The {0} term of the Fibonnaci sequence is {1:N0}.", CardinalToOrdinal(i), FibFunctional(i));
        }
    }
}
