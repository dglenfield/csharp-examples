using Microsoft.Extensions.DependencyInjection; // To use AddLocalization, AddTransient<T>.
...
// To enable special characters like Euro symbol.
...
string[] cultureCodes = ["da-DK", "en-GB", "en-US", "fa-IR", "fr-CA", "fr-FR", "he-IL", "pl-PL", "sl-SI"];
...
Write(Environment.NewLine + resources.GetEnterYourNamePrompt());
