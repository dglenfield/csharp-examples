...
//ConfigureConsole("fr-FR"); // French
//ConfigureConsole("en-GB"); // British English
...
WriteLine($"Is Christmas daylight savings time? {xmas.IsDaylightSavingTime()}");

WriteLine($"Is July 4th daylight savings time? {independenceDay.IsDaylightSavingTime()}");
WriteLine();
...
WriteLine("Culture: {0}, DayOfWeek: {1}", Thread.CurrentThread.CurrentCulture.NativeName, 
