...
{
    public async IAsyncEnumerable<StockPrice> GetStockPriceUpdates(string stock,
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            // The compiler does not need the extra parentheses but it is
            // clearer for humans if you put them in.
